...
import com.welltech.framework.aop.pagination.annotation.Paging;
import com.welltech.framework.aop.pagination.db.Dialect;
import com.welltech.common.util.ReflectionUtils;
import com.welltech.framework.aop.pagination.db.MySQLDialect;
...
public abstract class BaseInterceptor implements Interceptor, Serializable {
    ...
    protected static Page convertParameter(Object parameterObject, Page pageVO) throws NoSuchFieldException {
        if (parameterObject instanceof Page) {
            ...
            // 参数为某个实体，该实体拥有Page属性
            Paging paging = parameterObject.getClass().getAnnotation(Paging.class);//需要用paging注解
